...
#ifndef ROOMBA_500DRIVER_MEIJI_ROOMBA500SCI_H
#define ROOMBA_500DRIVER_MEIJI_ROOMBA500SCI_H
...
public:
  ...
  {
    const uint32_t usec = (uint32_t)(sec * 1000000u);
    usleep(usec);
  }
};

const float COMMAND_WAIT = 0.01;        // sec, this time is for Roomba 500 series
const uint16_t DEFAULT_VELOCITY = 200;  // mm/s

// DRIVE Special codes
const uint16_t STRAIGHT_RADIUS = 0x8000;
...
#endif  // ROOMBA_500DRIVER_MEIJI_ROOMBA500SCI_H
